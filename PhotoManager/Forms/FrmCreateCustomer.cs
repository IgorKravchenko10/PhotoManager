...
{
    public partial class FrmCreateCustomer : RibbonForm, IContextMenuHolder, IWindowTemplate, IBarManagerHolder, ISupportViewChanged, ISupportUpdate, IViewSiteTemplate, ISupportStoreSettings, IViewHolder
    {
        ...
        private Customer CreateCustomer()
        {
            Customer customer = new Customer()
            {
                ...
                PhoneNumber=textEditPhone.Text,
                CustomerNote=memoEdit1.Text
            };
        ...
        private void AddToDatabase()
        {
            ...
            pmContext.Customers.Add(CreateCustomer());
